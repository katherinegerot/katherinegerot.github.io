...
```
<nav class="dcf-idm dcf-flex-grow-1 dcf-d-flex dcf-jc-flex-end dcf-h-100% dcf-w-min-0 dcf-d-none@print" id="dcf-idm" role="navigation" aria-label="User Navigation">
	<div class="dcf-idm-status-logged-out dcf-idm-toggle dcf-ai-center dcf-relative dcf-header-global-item dcf-w-min-0">
		<a class="dcf-idm-login dcf-d-flex dcf-ai-center dcf-jc-center dcf-h-100% dcf-w-100% unl-font-sans" href=" < Link to Log In > ">
			<svg class="dcf-idm-img dcf-txt-sm dcf-h-6 dcf-w-6 dcf-circle unl-bg-cream" aria-hidden="true" focusable="false" height="16" width="16" viewBox="0 0 48 48">
...
<div class="dcf-search dcf-header-global-item dcf-flex-grow-1 dcf-d-flex dcf-jc-flex-end dcf-modal-parent dcf-d-none@print" id="dcf-search" role="search">
	<div class="dcf-search-toggle-wrapper dcf-ai-center dcf-w-100%">
		<button class="dcf-nav-toggle-btn dcf-nav-toggle-btn-search dcf-search-toggle dcf-d-flex dcf-ai-center dcf-jc-between dcf-w-100% dcf-p-0 dcf-txt-2xs dcf-bg-transparent dcf-b-1 dcf-b-solid unl-b-scarlet unl-font-sans unl-scarlet" id="dcf-search-toggle" aria-haspopup="true" aria-expanded="false" aria-label="open search">
	...
	<div class="dcf-modal-overlay dcf-mobile-toolbar-modal dcf-bg-overlay-light dcf-p-0" id="dcf-search-results" aria-hidden="true">
		<div class="dcf-d-flex dcf-flex-col dcf-flex-nowrap dcf-h-100% dcf-w-100%" role="document" tabindex="-1">
			<div class="dcf-bleed dcf-bg-center dcf-bg-no-repeat dcf-bg-cover unl-bg-scarlet unl-search-bg">
				<form class="dcf-wrapper dcf-search-form dcf-input-group-form dcf-d-flex dcf-ai-center dcf-pt-8 dcf-pb-8" id="dcf-search-form" action="https://search.unl.edu/" method="get">
			...
			<button class="dcf-absolute dcf-pin-top dcf-pin-right dcf-mt-3 dcf-mr-3 dcf-btn dcf-btn-inverse-tertiary" id="dcf-close-search" type="button">Close</button>
		</div>
	</div>
</div>
```

## $AC:AREAEX:HeaderImageBegin$
...
<div class="dcf-logo-lockup dcf-wrapper dcf-d-flex dcf-ai-flex-end dcf-relative dcf-overflow-hidden">
	<a class="dcf-header-logo dcf-mr-4 dcf-flex-shrink-0" id="dcf-header-logo" href="https://www.unl.edu/" aria-label="Go to University of Nebraska–Lincoln home page">
		<svg class="dcf-d-block dcf-h-8 dcf-w-8" focusable="false" height="76" width="76" viewBox="0 0 152 152">
			...
			<g id="n153">
				<path d="M147,1H90V42h10V75.673L53.532,2.393,52.648,1H2V42H12v66H2v41H62V108H52V74.336l46.467,73.271L99.351,149H150V108H140V42h10V1ZM59,111v35H5V111H15V39H5V4H51l52,82V39H93V4h54V39H137v72h10v35H101L49,64v47Z" fill="#fff"/>
			...
			<g id="n45">
				<path d="M89.818,3.455v38h10.364V76L53.545,3.455H3.455v38H13.818v69.091H3.455v38H62.182v-38H51.818V76l46.636,72.545h50.091v-38H138.182V41.455h10.364v-38ZM58.727,114v31.091H6.909V114H17.273V38H6.909V6.909H51.818l51.818,79.455V38H93.273V6.909h51.818V38H134.727v76h10.364v31.091H100.182L48.364,65.636V114Z" fill="#fff"/>
	...
	<div class="dcf-site-group dcf-d-flex dcf-flex-col dcf-jc-center unl-font-sans">
		<div class="dcf-site-affiliation dcf-lh-3 dcf-txt-2xs" id="dcf-site-affiliation">
			<a href="https://ianr.unl.edu/">Institute of Agriculture and Natural Resources</a>
		</div>
		<div class="dcf-site-title dcf-bold dcf-lh-2 dcf-uppercase unl-ls-1" id="dcf-site-title">
			<a class="dcf-txt-h6" href="www.ltap.unl.edu">Nebraska Local Technical Assistance Program</a>
		</div>
	</div>
</div>
```
		...
		<div class="dcf-wrapper dcf-pt-10 dcf-txt-xs">
			<div class="dcf-d-flex dcf-flex-wrap dcf-jc-between dcf-ai-center">
				<div class="dcf-d-flex dcf-ai-center dcf-mb-7 dcf-mr-7">
					<a class="unl-footer-logo" id="unl-footer-n" href="https://www.unl.edu/" aria-label="University of Nebraska–Lincoln">
					...
					<div class="dcf-ml-5 dcf-pl-4 dcf-bl-solid dcf-bl-1 unl-bl-cream">
						<a class="unl-footer-logo" id="unl-footer-150" href="https://n150.unl.edu/" aria-label="N 150">
							<svg class="dcf-d-block dcf-fill-current unl-n150" focusable="false" height="76" width="76" viewBox="0 0 292 180">
								<path d="M94.9 115.1c1.2-1.4 1.7-2.9 1.7-4.4 0-1.7-.6-3.2-1.7-4.5-1.2-1.3-2.8-2-5-2H64.7V14.6c0-1.9-.7-3.4-2-4.6-1.3-1.2-2.8-1.9-4.5-1.9-.3 0-1.8.1-2.1.2-3.2 1.1-6.5 2-9.7 2.8-3.2.8-6.5 1.5-9.7 2.1-3.2.6-6.5 1-9.7 1.3-3.2.2-6.4.4-9.5.4h-4.4c-1.4 0-2.8-.1-4.2-.2h-1c-2 0-3.5.6-4.6 1.7-1.1 1.2-1.7 2.4-1.9 3.8v.7c0 1.5.5 3 1.5 4.4 1 1.4 2.6 2.2 4.7 2.3 1.5.2 3.1.3 4.6.4H17c3.7 0 7.4-.2 11.1-.6 3.7-.4 7.4-.9 11.1-1.5v78.3H12.4c-2.3 0-4.1.7-5.2 2-1.2 1.3-1.7 2.8-1.7 4.5 0 1.5.6 3 1.7 4.4 1.2 1.4 2.9 2.1 5.2 2.1H90c2.1 0 3.8-.7 4.9-2.1z"/>
								<path d="M161.1 84.9c-5.4-5.7-11.8-10-19.3-12.8-7.4-2.8-15.1-4.3-23-4.4h-2.1c-4.2 0-8.3.3-12.3.8s-7.9 1.4-11.6 2.7l1.4-31.4H145l-.2.7c-.3.6-.6 1.2-.8 1.9-.2.6-.3 1.2-.3 1.9 0 1.2.3 2.3.9 3.3.6.9 1.4 1.7 2.3 2.3.6.3 1.2.5 1.7.7 1.9.5 3.9.1 5.5-1 .8-.5 1.5-1.4 2.1-2.4 1.9-3.3 12.5-21.6 16-27.5 4-6.6 7-11.7 4.4-15.5-1.8-2.8-5.6-3.6-8.4-1.8-1 .6-1.9 1.5-2.7 2.8l-6.3 10.9H88.4
							</svg>
						</a>
					</div>
				</div>
			...
			<div class="dcf-grid-halves@sm dcf-grid-fourths@md dcf-col-gap-vw dcf-row-gap-8 dcf-pb-7 dcf-lh-3 unl-font-sans">
				<div id="contactinfo" class="region region-contactinfo contactinfo">
					<div id="block-views-og-contact-us-block" class="block block-views">
						<div class="content">
							<div class="view view-og-contact-us view-id-og_contact_us view-display-id-block view-dom-id-9a237aa7b02e1dbc23d36b3097469eb2">
								<div class="view-content">
									<div class="views-row views-row-1 views-row-odd views-row-first views-row-last">
										<div class="views-field views-field-field-contact-info">
											<div class="field-content">
												<div class="vcard">
													<p><span class="wdn-icon-location adr" aria-hidden="true"></span><strong class="fn">Nebraska Local Technical Assistance Program</strong><br /> <span class="street-address">650 J Street, Suite 215 A</span><br /> <span class="locality">Lincoln</span>, <abbr class="region" title="Nebraska">NE</abbr> <span class="postal-code">68583-2900</span></p>
													<p><span class="wdn-icon-phone" aria-hidden="true"></span><a href="tel:402-472-5748" class="tel">402-472-5748</a></p>
													<p><span class="wdn-icon-print" aria-hidden="true"></span>402-472-0685</p>
													<p><span class="wdn-icon-mail" aria-hidden="true"></span><a href="mailto:pschwab@unl.edu" class="email">pschwab@unl.edu</a></p>
													<p><span class="wdn-icon-facebook" aria-hidden="true"></span><a href="https://www.facebook.com/ltapNE/">Nebraska LTAP</a></p>
												</div>
												<br />
											</div>
										</div>
					...
					<div id="block-views-og-contact-us-block-2" class="block block-views">
						<div class="content">
							<div class="view view-og-contact-us view-id-og_contact_us view-display-id-block_2 view-dom-id-ded719912fec79e780558857df7c1999">
								<div class="view-content">
									<div>
									</div>
								</div>
				...
				<div id="leftcollinks" class="region region-leftcollinks leftcollinks">
					<div id="block-views-og-contact-us-block-1" class="block block-views">
						<h2>Related Links</h2>
						<div class="content">
							<div class="view view-og-contact-us view-id-og_contact_us view-display-id-block_1 view-dom-id-1248aa0c9cc7bacbeafa91e4b47e4079">
								<div class="view-content">
									<div class="views-row views-row-1 views-row-odd views-row-first views-row-last">
										<div class="views-field views-field-field-related-links">
											<div class="field-content">
												<div class="item-list">
													<ul>
														<li class="first"><a href="http://extension.org/">eXtension</a></li>
														<li><a href="http://extension.unl.edu/">University of Nebraska Extension</a></li>
														<li><a href="http://dot.nebraska.gov/">Nebraska Department of Transportation</a></li>
														<li><a href="http://www.fhwa.dot.gov/">Federal Highway Administration</a></li>
														<li><a href="http://www.nhi.fhwa.dot.gov/">National Highway Institute</a></li>
														<li><a href="https://www.fhwa.dot.gov/innovation/everydaycounts/">Every Day Counts</a></li>
														<li class="last"><a href="http://nltapa.org/">National LTAP Association</a></li>
													</ul>
												</div>
											</div>
										</div>
				...
				<nav role="navigation" aria-labelledby="dcf-footer-group-3">
					<h2 id="dcf-footer-group-3">Campus Links</h2>
					<ul>
						...
						<li>
							<a href="https://www.unl.edu/tips-incident-reporting-system/">
								Report an Incident
								<br>
				...
				<nav role="navigation" aria-labelledby="dcf-footer-group-4">
					<h2 id="dcf-footer-group-4">Policies &amp; Reports</h2>
					<ul>
